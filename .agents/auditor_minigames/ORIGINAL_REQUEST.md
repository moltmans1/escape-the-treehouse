...
- Write your report to `/home/moltmans/escape-the-treehouse/.agents/auditor_minigames/audit.md`. If you find any violations, state them clearly. Message parent when done.
